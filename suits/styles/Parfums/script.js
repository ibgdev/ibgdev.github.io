...
var createShop = function () {
  ...
  for (var i = 0; i < catalog2.length; i++) {
    shop.appendChild(createProduct(catalog2[i], i));
  }
};
  ...
  if (quantity > 0) {
      ...
      if (existingItem) {
        ...
        if (existingQuantity + quantity <= 9) {
          ...
          var existingPrice = parseFloat(existingPriceText.substring(0, existingPriceText.length - 2)); // Remove " €" and parse as float
